                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-3" method="POST" action="{{url('/subcategory/'.$data->sub_id)}}" >
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <select class="form-control" name="sub_cat_id">
                                            ...
                                            <option value="{{ $value->category_id }}"  {{ ($value->category_id == $data->sub_cat_id) ? 'selected' : '' }}>{{ $value->category_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nametext" aria-describedby="name"
                                            name="sub_cat_name"value="{{ $data->sub_cat_name }}"/>
